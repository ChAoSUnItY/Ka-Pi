...
impl Class {
    ...
    pub fn this_class_mut(&mut self) -> Option<&mut crate::node::constant::Class> {
    ...
    /// Get super class from constant pool.
    pub fn super_class_mut(&mut self) -> Option<&mut crate::node::constant::Class> {
    ...
    /// Get interface from constant pool at given index.
    pub fn interface_mut(&mut self, index: u16) -> Option<&mut crate::node::constant::Class> {
        if let Some(Constant::Class(class)) = self
            .interfaces
            .get(index as usize)
