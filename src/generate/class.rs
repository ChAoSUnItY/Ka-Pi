...
use crate::generate::field::FieldWriter;
use crate::generate::method::MethodWriter;
use crate::generate::symbol::SymbolTable;
use crate::node::access_flag::{AccessFlags, ClassAccessFlag, FieldAccessFlag, MethodAccessFlag};
...
mod test {
    use crate::error::KapiResult;
    use crate::generate::class::ClassWriter;
    use crate::generate::field::FieldWriter;
    use crate::generate::method::MethodWriter;
