...
pub(crate) fn fields<'input: 'constant_pool, 'constant_pool>(input: &'input [u8], constant_pool: &'constant_pool ConstantPool) -> IResult<&'input [u8], (u16, Vec<Field>)> {
...
fn field<'input: 'constant_pool, 'constant_pool>(input: &'input [u8], constant_pool: &'constant_pool ConstantPool) -> IResult<&'input [u8], Field> {
